...
namespace Ext
{
    namespace Graphics
    {
        ...
        public:
            ...
            void Draw(Ext::Graphics::Text* text, const Ext::Graphics::Point2u& pos, const Ext::Graphics::Point2u& size);
            void Draw(Ext::Graphics::Text* text, const Ext::Graphics::Point2u& pos);
