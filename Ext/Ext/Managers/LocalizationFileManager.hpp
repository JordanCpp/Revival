...
namespace Ext
{
    namespace Managers
    {
        ...
        {
        public:
            LocalizationFileManager(Ext::Managers::PathManager* pathManager, Ext::Loaders::LocalizationFileLoader* localizationFileLoader, Ext::Readers::JsonReader * jsonReader);
