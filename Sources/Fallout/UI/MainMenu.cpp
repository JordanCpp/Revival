	...
	_LocalizationManager(localizationManager)
{
	...
	_LocalizationManager->Interface("MainMenu.json");

	_NewGame = _WidgetManager->NewButton(_LocalizationManager->Get(1), Ext::Graphics::Point2u(5, 5), Ext::Graphics::Point2u(145, 35));
	_NewGame->OnClick = std::bind(&MainMenu::NewGame, this, std::placeholders::_1);
	_Window->Attach(_NewGame);

	_Editor = _WidgetManager->NewButton(_LocalizationManager->Get(2), Ext::Graphics::Point2u(5, 45), Ext::Graphics::Point2u(145, 35));
	_Editor->OnClick = std::bind(&MainMenu::Editor, this, std::placeholders::_1);
	_Window->Attach(_Editor);

	_Setting = _WidgetManager->NewButton(_LocalizationManager->Get(3), Ext::Graphics::Point2u(5, 85), Ext::Graphics::Point2u(145, 35));
	_Setting->OnClick = std::bind(&MainMenu::Setting, this, std::placeholders::_1);
	_Window->Attach(_Setting);

	_Exit = _WidgetManager->NewButton(_LocalizationManager->Get(4), Ext::Graphics::Point2u(5, 125), Ext::Graphics::Point2u(145, 35));
